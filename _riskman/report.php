    ...
    <div id="Log" class="tabs">
      <table class="w3-table-all w3-hoverable">
        ...
        <tr>
          ...
          <td class="caller_type"><?php echo $row['caller_type']; ?></td>
          <td class="incident_report"><?php echo $row['incident_report']; ?></td>
          <td class="report_num"><?php echo $row['report_num']; ?></td>
