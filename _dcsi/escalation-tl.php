    ...
    <div class="w3-container" id="senior" style="margin-top:75px">
      ...
      <form action="../php/#.php" method="POST">
        ...
        <div class="w3-row-padding w3-margin-bottom">
          <input class="w3-input w3-border w3-margin-bottom" type="text" name="firstname" required="" placeholder="">
          <input class="w3-input w3-border w3-margin-bottom" type="text" name="surname" required="" placeholder="">
        </div>
        <div class="w3-row">
