...
<div class="w3-main" style="margin:40px 40px 0 340px">
  <div class="w3-container w3-margin-top">
    ...
    <div class="w3-quarter">
      <p></p>
      <button type="button" onclick="window.location.href = '/_engie_f/contact_directly.php'" class="w3-button w3-block w3-card w3-padding-32 w3-khaki">Contact Branch (BU) Directly</button>
    </div>
  </div>
