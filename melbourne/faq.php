    ...
    <div class="w3-row" style="margin-top:25%">
      <div class="w3-half w3-padding">
        <div class="w3-twothird w3-padding-16">
          <button type="button" onclick="window.location.href = '/melbourne/escalation.php'" class="w3-button w3-block w3-padding-32 w3-pale-yellow w3-card">Escalation</button>
        </div>
      </div>
      <div class="w3-half">
        <div class="w3-row">
