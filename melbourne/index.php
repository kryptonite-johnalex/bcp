...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <!-- Header -->
    <div class="w3-container" id="top">
      ...
      <h1 class="w3-jumbo w3-text-pink w3-center"><b>THIS IS MELBOURNE</b></h1>
      <h1 class="w3-xxxlarge w3-text-red"><b></b></h1>
      <p>Thank you for calling The Royal Melbourne Hospital Home Lottery, <?php echo (isset($_SESSION["agent"])) ?: '[Agent Name]'; ?> speaking. Would you like to order a ticket?</p>
    </div>
